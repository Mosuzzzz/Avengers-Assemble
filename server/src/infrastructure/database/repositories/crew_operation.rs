...
use std::sync::Arc;
use crate::{domain::{entities::crew_memberships::CrewMembershipEntity, repositories::crew_operation::CrewParticipationRepository}, infrastructure::database::{postgresql_connection::PgPoolSquad, schema::crew_memberships}};
use anyhow::Result;
...
#[async_trait]
impl CrewParticipationRepository for CrewPostgres {
